      ...
      <div className="ac-container ac-submitted">
        <div className="ac-card">
          ...
          <p className="ac-text-muted">
            Your account closure request has been received and is being
            processed. You'll receive updates via SMS and email.
          </p>

          <div className="ac-alert ac-alert-danger">
            <h5 className="ac-alert-title">Request Details:</h5>
            <p>
              <strong>Request ID:</strong> AC
            ...
            <p>
              ...
              <span className="ac-text-warning">Under Review</span>
            </p>
          </div>

          <div className="ac-alert ac-alert-warning">
            <AlertTriangle className="ac-alert-icon" />
            <strong>Important:</strong> Please ensure all pending transactions
            are completed and maintain minimum balance until closure is
            confirmed.
          </div>
        ...
        <div className="ac-right-panel">
            ...
            {[
              ...
              return (
                <div key={index} className="ac-step">
                  <div
                    className={`ac-step-circle ${
                      isActive ? "ac-step-active" : ""
                    }`}
                  >
                    {stepNumber}
                  </div>
                  <small
                    className={`ac-step-label ${
                      isActive ? "ac-label-active" : ""
                    }`}
                  >
                    {label}
                  </small>
                  {index < 3 && (
                    <div
                      className={`ac-step-line ${
                        currentStep > stepNumber ? "ac-filled" : ""
                      }`}
                    />
                  )}
                </div>
          ...
          <div className="ac-card">
            ...
            {currentStep === 1 && (
              <>
                <h4 className="ac-card-title">
                  <CreditCard className="ac-icon" /> Account Information
                </h4>
                ...
                <div className="ac-form-group">
                  ...
                  {formData.confirmAccountNumber &&
                    formData.accountNumber !==
                      formData.confirmAccountNumber && (
                      <small className="ac-text-danger">
                ...
                <div className="ac-alert ac-alert-danger">
                  ...
                  <strong>Security Notice:</strong> Ensure you're on our
                  official website. Never share PIN/OTP here.
                </div>
              </>
            )}
            ...
            {currentStep === 2 && (
              <>
                <h4 className="ac-card-title">
                  <User className="ac-icon" /> Personal Information
                </h4>
                <div className="ac-form-group">
                ...
                <div className="ac-alert ac-alert-info">
                  ...
                  All information must match bank records. Verification may be
                  required.
                </div>
              </>
            )}
            ...
            {currentStep === 3 && (
              <>
                <h4 className="ac-card-title">
                  <FileText className="ac-icon" /> Closure Details
                </h4>
                <div className="ac-form-group">
            ...
            {currentStep === 4 && (
              <>
                <h4 className="ac-card-title">
                  <CheckCircle className="ac-icon" /> Review & Confirmation
                </h4>
                <div className="ac-review-section">
                  <h6>Account Details</h6>
                  <p>
                    <strong>Type:</strong> {formData.accountType}
                  </p>
                  <p>
                  ...
                  <p>
                    <strong>Holder:</strong> {formData.fullName}
                  </p>
                  <p>
                ...
                <div className="ac-review-section">
                  ...
                  <p>
                    <strong>Reason:</strong> {formData.closureReason}
                  </p>
                  {formData.otherReason && (
                    <p>
                      <strong>Other:</strong> {formData.otherReason}
                    </p>
                  )}
                  <p>
                    <strong>Balance Transfer:</strong>{" "}
                    {formData.transferBankName} (****
                    {formData.transferAccount.slice(-4)})
                  </p>
                </div>
                <div className="ac-alert ac-alert-danger">
            ...
            <div className="ac-btn-group ac-btn-nav">
              <button
                ...
                onClick={() => {
                  if (currentStep === 1) {
                    navigate("/client/myaccount"); // 👈 Step 1 asel tar redirect
                  } else {
                    prevStep(); // 👈 nahi tar previous step var ja
                  }
                }}
              >
                ← Back
              ...
              {currentStep < 4 ? (
                ...
                <button
                  ...
                  disabled={!formData.acknowledgment}
                >
                  ✅ Submit Request
                </button>
              )}
            ...
            <div className="ac-text-muted ac-footer">
