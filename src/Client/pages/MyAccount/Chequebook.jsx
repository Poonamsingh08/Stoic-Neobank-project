      ...
      <div className="cbr-container">
        <div className="cbr-center-card">
          ...
          <p className="cbr-subtext">
            Your cheque book request has been received. You will receive a
            confirmation SMS and email shortly.
          </p>
          <div className="cbr-alert">
            <p>
              <strong>Request ID:</strong> CB
      ...
      <div className="cbr-form-wrapper">
        ...
        <div className="cbr-right-panel">
          ...
          <div className="cbr-stepper">
            {["Account Details", "Personal Info", "Delivery"].map(
              (label, index) => {
                ...
                return (
                  <div key={index} className="cbr-step">
                    <div
                      className={`cbr-step-circle ${
                        isActive ? "cbr-active-step" : ""
                      }`}
                    >
                      {stepNumber}
                    </div>
                    <small
                      className={`cbr-step-label ${
                        isActive ? "cbr-step-active-label" : ""
                      }`}
                    >
                      {label}
                    </small>
                    {index < 2 && (
                      <div
                        className={`cbr-step-line ${
                          currentStep > stepNumber ? "cbr-step-line-active" : ""
                        }`}
                      />
                    )}
                  </div>
          ...
          <div className="cbr-form-card">
            ...
            {currentStep === 1 && (
              <div>
                <h4 className="cbr-form-title">
                  <CreditCard className="cbr-icon" size={20} /> Account Details
                </h4>
                  ...
                  <div className="cbr-radio-group">
                    ...
                    <label className="cbr-radio">
                      <input
                        ...
                        name="deliveryType"
                        value="branch"
                        checked={formData.deliveryType === "branch"}
                        onChange={handleInputChange}
                      />
            ...
            {currentStep === 2 && (
              <div>
                <h4 className="cbr-form-title">
                  <User className="cbr-icon" size={20} /> Personal Information
                </h4>
                <div className="cbr-form-group">
                ...
                <div className="cbr-alert-info">
                  <AlertCircle size={18} /> <strong>Important:</strong> Please
                  ensure your contact details are up to date for delivery
                  notifications.
                </div>
              </div>
            )}
            ...
            {currentStep === 3 && (
              <div>
                <h4 className="cbr-form-title">
                  <MapPin className="cbr-icon" size={20} /> Delivery Address
                </h4>
                <div className="cbr-form-group">
                ...
                <div className="cbr-summary-card">
                  ...
                  <p>
                    <strong>Number of Books:</strong> {formData.numberOfBooks}{" "}
                    Book(s)
                  </p>
                  <p>
            ...
            <div className="cbr-nav-buttons">
              <button
                className="cbr-btn-outline"
                onClick={() => {
                  if (currentStep === 1) {
                    navigate("/Client/myaccount"); // Step 1 → redirect
                  } else {
                    prevStep(); // Step > 1 → previous step
                  }
                }}
              >
                ← Previous
              ...
              {currentStep < 3 ? (
                <button className="cbr-btn-next" onClick={nextStep}>
                  Next Step →
                </button>
              ) : (
                <button className="cbr-btn-submit" onClick={handleSubmit}>
                  {" "}
                  Submit Request
                </button>
              )}
            ...
            <div className="cbr-help-text">
              Need help? Contact our customer support at 1800-XXX-XXXX <br />{" "}
